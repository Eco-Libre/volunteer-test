...
If you're reading this, then you're probably looking to apply to be a volunteer with `Eco-Libre <https://eco-libre.org>`_
...
.. note:: Be patient, and set your expectations appropriately. Completion of the Eco-Libre Volunteer Test will take you between a day and a few weeks. Or more.
...
Eco-Libre strongly recommends that you use `Linux Mint Debian Edition <https://www.linuxmint.com/download_lmde.php>`_, but you can use whatever Linux system you want, as long as you can install git, inkscape, gimp, kdenlive, freecad, sphinx, and python.
...
If you don't yet already have one, `create an account on GitHub <https://github.com/signup>`_
...
#. Create a sheet of metal 1 meter x 1 meter x 20 cm
#. Using the Sketch workbench, carve your initials into the metal (5 cm deep).
...
#. https://maltfield.github.io/eco-libre-volunteer-test/
